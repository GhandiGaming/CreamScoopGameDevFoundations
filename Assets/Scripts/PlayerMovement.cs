...
public class PlayerMovement : MonoBehaviour
{
    ...
    private void Update()
    {
       ...
       if (isGrounded & Input.GetKey(KeyCode.W) || isGrounded & Input.GetKey(KeyCode.S) || isGrounded & Input.GetKey(KeyCode.A) || isGrounded & Input.GetKey(KeyCode.D))
        {
            Walk.enabled = true;
        }
       else
    ...
    public void SetSpeed(float newMS)
    {
        moveSpeed += newMS;
    }
}
